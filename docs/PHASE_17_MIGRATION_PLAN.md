...
**Status**: DRAFT 2026-04-24 · ships as v2.4.8 · table APPROVED by user 2026-04-24.
**Depends on**: v2.4.7 (Fresh-start UX) merged.
**Blocks**: v2.4.9 primary-layer rework, because that work also touches `validateGap`.
