...
- ~~BUG-WS-2 fix~~ — Push-to-AI JSON-parse failure ("Unterminated string in JSON at position 3713") · max_tokens passthrough on Anthropic/OpenAI/Gemini · repairTruncatedJson 5-step recovery (escape stray newlines · close unterminated strings + braces · strip trailing commas) · retry-once with strict-JSON discipline reminder · 6 regression tests added (V-FLOW-WS-PARSE-1/2/REPAIR-1 + V-FLOW-WS-ERROR-BANNER-1 [BUG-WS-1 retroactive guard] + V-FLOW-WS-PUSH-MAX-TOKENS-1 + V-FLOW-WS-PUSH-RETRY-1) · feature is NOW functionally operational end-to-end · 1329/1329 GREEN · shipped at `8b845a4`
