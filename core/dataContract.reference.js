// core/dataContract.reference.js
//
// ─────────────────────────────────────────────────────────────────────
//  REFERENCE ONLY · NOT ACTIVE · DO NOT IMPORT
// ─────────────────────────────────────────────────────────────────────
//
// This is the ORIGINAL v3 data contract as authored on 2026-05-02
// (commit 26b5fb4). It has been PROMOTED OUT OF SERVICE and replaced
// by the rebuilt contract that now lives at `core/dataContract.js`
// (formerly `core/dataContract.next.js`).
//
// Kept on disk as a historical reference so the diff between the
// original and the rebuilt contract stays readable. The runtime
// + every consumer imports from `core/dataContract.js`. Nothing
// imports from this file.
//
// Replacement date: 2026-05-11
// Replacement rationale: docs/UI_DATA_TRACE.md (r6) audit surfaced
//   that the original 26-path STANDARD_MUTABLE_PATHS was incomplete
//   (no catalog-resolved label paths, no derived Insights category),
//   causing runtime resolution to fail for ~85% of skill bindings
//   (every collection-entity path returned "[?]"). The rebuilt
//   contract expands Standard to 34 paths with label-resolved
//   variants, adds the Insights catalog (15 derived paths from §S5
//   selectors), and tightens the non-mutable exclusion list.
//
// If you need to read the historical shape: this file is the truth.
// If you need to consume the contract at runtime: import from
// `core/dataContract.js`. Touching this file changes nothing the
// app reads.
//
// ─────────────────────────────────────────────────────────────────────
//
// Below: original file content preserved verbatim.
//
// ─────────────────────────────────────────────────────────────────────
